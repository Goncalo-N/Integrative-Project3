...
public class Algorithms {
    ...
    public static <V, E > E shortestPath(Graph<V, E> g, V vOrig, V vDest,
        ...
        //isto como está cria um array de Producer Particular ou Company e nao de Hub
        V[] pathKeys = (V[]) Array.newInstance(Object.class, g.numVertices());
        E[] dist = (E[]) Array.newInstance(zero.getClass(), g.numVertices());
    ...
    public static <V, E> E graphDiameter(Graph<V, E> g, Comparator<E> comp, BinaryOperator<E> sum, E zero) {
        ...
        for (int i = 0; i < numVerts; i++) {
            for (int j = 0; j < numVerts; j++) {
                if (result.edge(i, j).getWeight() != null && comp.compare(result.edge(i, j).getWeight(), max) < 0) {
