...
public class ProductProvided {
     ...
     */
    public ProductProvided(CabazProduct product, double requestedQuantity, double deliveredQuantity, Producer provider) {
     ...
     */
    private void checkProductProvided(CabazProduct product) {
        if (product == null)
    ...
    public boolean equals(Object otherObj) {
        ...
        boolean providerEquals = (provider != null && otherProductProvided.provider != null
                && provider.getProducerID().equals(otherProductProvided.provider.getProducerID()))
