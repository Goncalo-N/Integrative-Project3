-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Trigger que é executado quando uma operação de escrita do tipo UPDATE é realizada
CREATE OR REPLACE TRIGGER 
ADICIONAR_UPDATE_AUDITORIA
...
DECLARE
    ...
    TIPO_DE_ALTER                           PISTA_DE_AUDITORIA.ID_TIPO_DE_ALTERACAOTIPO_DE_ALTERACAO%TYPE := 1;
    EX_ERRO EXCEPTION;
BEGIN
    ...
    IF (:NEW.ID_OPERACAO > 0) THEN
        ...
        UPDATE PISTA_DE_AUDITORIA
        SET
            ID_OPERACAOOPERACAO_PA = :NEW.ID_OPERACAO
        WHERE
            ID_OPERACAOOPERACAO_PA = :OLD.ID_OPERACAO;
