-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Trigger que é executado quando uma operação de escrita do tipo DELETE é realizada
CREATE OR REPLACE TRIGGER 
ADICIONAR_DELETE_AUDITORIA
...
DECLARE
    ...
    TIPO_DE_ALTER                           PISTA_DE_AUDITORIA.ID_TIPO_DE_ALTERACAOTIPO_DE_ALTERACAO%TYPE := 3;
    EX_ERRO EXCEPTION;
BEGIN
